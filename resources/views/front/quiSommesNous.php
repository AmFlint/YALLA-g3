...
<body>
	<body class="site">
		...
		<div class="contentPageWhoAreYou">
			...
			<div class="row marginTopContentPageWhoAreYou">
				...
				<div class="col-xs-12 col-md-5 offset-md-1">
					<div class="containerImgPageWhoAreYouSecond">
						<img class="positionnement widthImgSectionTwo" src="" alt="">
						<div class="rectImgColorPink"></div>
					</div>
				</div>				
			</div>
			<div class="row">
				<div class="bannerPageWhoAreYou">
					<img class="" src="" alt="">
					<div class="rectImgColorRedBanner"></div>
				</div>
			</div>
			...
			<div class="row justify-content-around text-center marginTopContentPageWhoAreYou">
				<div class="col-xs-12 col-md-3 containerImgNotreStrategie">
					<img class="" src="" alt="">
			...
			<div class="row text-center justify-content-around marginTopContentPageWhoAreYou">
				<div class="col-xs-12 col-md-3 containerImgNotreStrategie">
					<img class="" src="" alt="">
			...
			<div class="bannerPageWhoAreYou text-center" style="background-color: #D8D8D8;">
				<p>Un petit geste à plusieurs, un grand pas ensemble</p>
