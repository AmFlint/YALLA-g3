...
<body>
	<body class="site">
		<div class="quiSommesNousBg">
			...
			<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
				...
				<div class="collapse navbar-collapse text-uppercase justify-content-end" id="navbarNavDropdown">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link" href="#">Qui some nous ?</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="#">Notre quotidient</a>
						</li>
						<li class="nav-item">
		...
		<div class="contentPageWhoAreYou">
			...
			<div class="row marginTopContentPageWhoAreYou">
				...
				<div class="col-xs-12 col-md-5 offset-md-1">
					<div class="containerImgPageWhoAreYouSecond">
						<img class="positionnement widthImgSectionTwo" src="../../../public/img-content/front/quiSommesNous2.jpg" alt="">
			...
			<div class="row justify-content-around marginTopContentPageWhoAreYou">
				...
				<div class="col-xs-12 col-md-3">
					<img class="alignBottomClassic" src="../../../public/img-layout/class-group-of-students-and-professor-in-front.svg" alt="">
				...
				<div class="col-xs-12 col-md-3">
					<img class="alignBottomClassic" src="../../../public/img-layout/world.svg" alt="">
				...
				<div class="col-xs-12 col-md-3">
					<img class="alignBottomClassic" src="../../../public/img-layout/link.svg" alt="">
			...
			<div class="row text-center marginTopContentPageWhoAreYou">
				<div class="col-xs-12 offset-xs-0 col-md-3 offset-md-2 containerImgNotreStrategie">
					<img class="" src="../../../public/img-content/front/quiSommesNous4.jpg" alt="">
					<div class="rectImgColorRedStrategieOne"></div>
					<p>Mary LEMELAND-MELLIONEC, Présidente de l’association</p>
				</div>
				<div class="col-xs-12 offset-xs-0 col-md-3 offset-md-2 containerImgNotreStrategie">
					<img src="../../../public/img-content/front/quiSommesNous5.jpg" alt="">
			...
			<div class="row text-center marginTopContentPageWhoAreYou">
				<div class="col-xs-10 offset-xs-0 col-md-3 offset-md-2 containerImgNotreStrategie">
					<img class="" src="../../../public/img-content/front/quiSommesNous6.jpg" alt="">
					<div class="rectImgColorRedStrategieThree"></div>
					<p>Sophie FANUCCHI, Secrétaire et référente juridique</p>
				</div>
				<div class="col-xs-12 offset-xs-0 col-md-3 offset-md-2 containerImgNotreStrategie">
					<img class="" src="../../../public/img-content/front/quiSommesNous7.jpg" alt="">
		...
		<footer>
			<div class="row rowMarginTopFixCallToAction alignTopFooter">
				<div class="col-xs-6 col-md-1 offset-md-5 text-center">
					<img src="../../../public/img-layout/twitter.svg" alt="">
				</div>
				<div class="col-xs-6 col-md-1 text-center">
					<img src="../../../public/img-layout/facebook.svg" alt="">
				</div>
			</div>
			<div class="col-xs-12 col-md-12 text-center alignBottomClassic">
