...
<div class="contentPageWhoAreYou">
	...
	<div class="row justify-content-around marginTopContentPageWhoAreYou">
		...
		<div class="col-xs-12 col-md-3">
			...
			<p class="paddingTopFix text-center">et de la communauté d’accueil à tous les stades de développement du projet afin de garantir une compréhension mutuelle des enjeux et objectifs du projet, et contribuer au succès de la mission.</p>
		</div>
		<div class="col-xs-12 col-md-3">
			...
			<p class="paddingTopFix text-center">afin de créer une solidarité de proximité et garantir une visibilité sur la destination et l’impact des dons quels que soient leurs montants, tout en faisant parvenir aux bénéficiaires un message de soutien concret de la part de la société civile solidaire.</p>
		</div>
		<div class="col-xs-12 col-md-3">
			...
			<p class="paddingTopFix text-center">menée par les agences humanitaires des Nations Unies, afin de s’intégrer dans une action globale et parvenir ensemble à plus d’efficacité pour répondre aux besoins les plus prégnants.</p>
		</div>
	</div>
	...
	<div class="bannerPageWhoAreYou text-center">
		<p class="bannerPageWhoAreYouAlignTop">Un petit geste à <span class="fontWeightBoldDubai">plusieurs</span>, un grand pas <span class="fontWeightBoldDubai">ensemble</span></p>
