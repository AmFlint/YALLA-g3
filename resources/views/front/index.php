...
<body class="site">
  <!-- header -->
  <video src="../../../public/video/backgroundHomePage.mp4" autoplay="1" loop="1"></video>
  ...
  <div class="contentHomePage">
    <div class="row">
      <div class="col-xs-12 col-md-5 offset-md-1 paddingFix">
        <img src="../../../public/img-content/front/homePage1.jpg" alt="">
      ...
      <div class="col-xs-12 col-md-5 alignContainerTextHomePageRight desktopText">
        ...
        <img src="../../../public/img-layout/picto-plus-copy.svg" alt="">
      </div>
    </div>
    <div class="row rowMarginTopFix">
      ...
      <div class="col-xs-12 col-md-5 paddingFix orderContentHomePage">
        <img src="../../../public/img-content/front/homePage2.jpg" alt="">
    ...
    <div class="row rowMarginTopFix">
      <div class="col-xs-12 col-md-5 offset-md-1 paddingFix">
        <img src="../../../public/img-content/front/homePage3.jpg" alt="">
  ...
  <div class="row rowMarginTopFixCallToAction">
    ...
    <div class="col-md-4 offset-md-4 col-xs-12 text-center">
      <img src="../../../public/img-content/front/homePage4.jpg" alt="">
