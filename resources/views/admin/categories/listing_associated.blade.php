...
@section('content')
    <div>
        <div class="col-xs-10 col-md-10 col-lg-10 col-xl-10 offset-md-1 alignTop ">
            <h1 class="h1 text-center">Articles liés à la catégorie <span class="text-info">{{$category->name}}</span></h1>
            ...
            @endif
            <div class="marginBottomAjoutArticle tagsLink">
                @foreach($categories as $category)
                    <button class="btn btn-info"><a href="{{route('admin.categories_assoc_posts', $category->id)}}">{{$category->name}}</a></button>
                @endforeach
            </div>
            <div class="row">
